...
SELECT COUNT(*) AS rows_loaded, COUNT(DISTINCT SRC_FILE_NAME) AS files, MAX(PPN_ID) AS ppn
...
-- SELECT * FROM DEV_DB.SILVER.CUSTOMER;   -- new column present; SRC_FILE_NAME NOT added to SILVER
