...
ALTER SCHEMA IDENTIFIER($DB_NAME || '.' || $SCHEMA_NAME) SET DATA_RETENTION_TIME_IN_DAYS = 7;
...
SET FULL_ROLE = $DB_NAME || '.' || $SCHEMA_NAME || '_FULL_AR';
CALL CREATE_SCHEMA($DB_NAME, $SCHEMA_NAME, $ENV_ABBR);
ALTER SCHEMA IDENTIFIER($DB_NAME || '.' || $SCHEMA_NAME) SET DATA_RETENTION_TIME_IN_DAYS = 1;
GRANT DATABASE ROLE IDENTIFIER($RO_ROLE)   TO ROLE IDENTIFIER($R_IT_GOVERNANCE);
GRANT DATABASE ROLE IDENTIFIER($FULL_ROLE) TO ROLE IDENTIFIER($R_TRANSFORMER);
GRANT DATABASE ROLE IDENTIFIER($FULL_ROLE) TO ROLE IDENTIFIER($R_DATA_LOADER);
...
SET FULL_ROLE = $DB_NAME || '.' || $SCHEMA_NAME || '_FULL_AR';
CALL CREATE_SCHEMA($DB_NAME, $SCHEMA_NAME, $ENV_ABBR);
ALTER SCHEMA IDENTIFIER($DB_NAME || '.' || $SCHEMA_NAME) SET DATA_RETENTION_TIME_IN_DAYS = 14;
GRANT DATABASE ROLE IDENTIFIER($RO_ROLE)   TO ROLE IDENTIFIER($R_ANALYST);
GRANT DATABASE ROLE IDENTIFIER($RO_ROLE)   TO ROLE IDENTIFIER($R_IT_GOVERNANCE);
