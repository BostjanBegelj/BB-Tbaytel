...
RETURNS VARIANT
LANGUAGE SQL
COMMENT = 'Loads files from external stage to EX.<table>. Does not load EX_HIST.'
EXECUTE AS CALLER
AS
DECLARE
...
BEGIN
    ...
    /* ============================================================
       4. CREATE EX TABLE FROM INFERRED SCHEMA
       ============================================================ */
    v_phase := 'CREATE_EX_TABLE';
    v_sql := '
    ...
    CALL ADM.SP_WRITE_PPN_LOG(
        ...
        PPN_PHASE          => 'LOAD FROM LANDING TO EX',
